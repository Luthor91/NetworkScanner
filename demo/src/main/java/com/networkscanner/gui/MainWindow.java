...
public class MainWindow extends JFrame {
    ...
    private List<ModelScanResult> currentResults;
    ...
    private void startScan() {
        ...
        SwingWorker<Void, ModelScanResult> worker = new SwingWorker<Void, ModelScanResult>() {
            @Override
            protected Void doInBackground() throws Exception {
                ...
                for (int i = 0; i < selectedIPs.size(); i++) {
                    ...
                    try {
                        ModelScanResult result = new ModelScanResult();
            ...
            @Override
            protected void process(List<ModelScanResult> chunks) {
                for (ModelScanResult result : chunks) {
